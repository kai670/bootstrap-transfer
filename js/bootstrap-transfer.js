(function($) {
	$.fn.bootstrapTransfer = function(options) {
		...
		return this.each(function() {
			...
			_this.find('select.filtered.target').height(
					_this.find('select.filtered.target').height() + $(".bootstrap-transfer-container .selector-filter").outerHeight());
			/* #=============================================================================== */
			...
			_this.update_lists = function(force_hilite_off) {
				var old;
				if (!force_hilite_off) {
					old = [ _this.to_dict(_this.get_internal(_this.$remaining_select)), _this.to_dict(_this.get_internal(_this.$target_select)) ];
				}
